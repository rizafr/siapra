...
<div class="navbar navbar-inverse">
	...
	<form action="<?php echo base_URL()?>surat_keluar/keluar/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">No. Agenda</td><td><b><input type="text" autofocus tabindex="1" id="no_agenda" name="no_agenda" readonly value="<?php echo $no_agenda; ?>" style="width: 100px" class="form-control"></b></td></tr>
		...
		<a href="<?php echo base_URL()?>surat_keluar/keluar" tabindex="10" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>
		</table>
	</div>
