...
--
-- Inang: 127.0.0.1
-- Waktu pembuatan: 30 Jul 2015 pada 15.00
-- Versi Server: 5.5.27
-- Versi PHP: 5.4.7
...
INSERT INTO `surat_masuk` (`id_surat_masuk`, `kode_surat_masuk`, `no_surat_masuk`, `asal_surat_masuk`, `tgl_surat_masuk`, `status_surat_masuk`, `perihal_surat_masuk`, `index_surat_masuk`, `no_agenda`, `lampiran`, `tgl_diterima`, `pengolah`, `keterangan`) VALUES
(1, '1', '1', 'Disduk', '2015-07-01', 'Rahasia', 'tes tes', 'tes', '1', '', '2015-07-01', 1, ''),
(2, 'or', '9r', 'ir', '2015-07-28', 'pr', 'or', 'pr', '0002', '', '2015-07-30', 1, 'r'),
(4, 't', 't', 't', '2015-07-21', 'Penting', 't', 't', '0005', '', '2015-07-30', 1, 'r');
